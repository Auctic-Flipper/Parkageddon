...
def garage_c_dashboard():
    ...
    floor3_ids = _parse_list_env("GARAGE_C_FLOOR3_LOCATIONS")
    floor4_ids = _parse_list_env("GARAGE_C_FLOOR4_LOCATIONS")
    total_ids = _parse_list_env("GARAGE_C_TOTAL_LOCATIONS")
